...
{
	public static IHttpClientBuilder AddAccessToken(this IHttpClientBuilder builder)
	{
	...
	private class HttpClientAuthorizationDelegatingHandler : DelegatingHandler
	{
		...
		public HttpClientAuthorizationDelegatingHandler(
			IHttpContextAccessor httpContextAccessor, HttpMessageHandler innerHandler)
			: base(innerHandler)
		{
			_httpContextAccessor = httpContextAccessor;
		}
